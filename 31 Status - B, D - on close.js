...
var editDateOnClose = "2023-07-29 1607"
...
function intakes(){
	...
	function parseIntake(str){
		...
		//allergens - as of 2023-04-10 these no longer exist.
	...
	for(var a=0; a<arAllIntakes.length; ++a){
		...
		//update stuff.
			...
			//we need to get the field contents from the reference library
...
log("Status - B, D - on close.js" + editDateOnClose + " loaded");
